	...
	<section id="hero">
		<div class="hero-container" id = "wrap">
			...
			<div class="text-center" style="text-align:center;">
				<input type="button" onclick="location.href='writeList'" value="목록가기" style="width: 140px; height: 42px;">
				<input type="button" onclick="location.href='writeModify?num=${detail.num}'" value="글 수정" style="width: 140px; height: 42px;">
				<input type="button" onclick="location.href='writeDelete?num=${detail.num}&loginnick=${nick}&nick=${detail.nick}&level=${Level}'"value="글 삭제" style="width: 140px; height: 42px;">
			</div>
			</form>
...
if(loginnick == nick){
	location.href="writeDelete?'num=${detail.num}";
} else {
	alert('비밀번호가 틀립니다.');
}
} */
