...
<%-- 			<h1>${nick }</h1>
			...
			<form action="myWriteList" method="post" role="form"
				...
				<input type="button" onclick="location.href='memberLogin'" value="로그아웃" style="width: 170px; height: 42px;">
				<input type="button" onclick="location.href='MemberModifyForm.jsp'" value="회원정보 수정" style="width: 170px; height: 42px;">
				<input type="button" onclick="location.href='memberDelete?id=${id}&nick=${nick}'" value="회원 탈퇴" style="width: 170px; height: 42px;"><br/><br/>
	...
	<section id="hero">
		<div class="hero-container">
			...
			<form action="myWriteList" method="post" role="form"
				...
				<input type="button" onclick="location.href='memberLogin'" value="로그아웃" style="width: 190px; height: 42px;">
				<input type="button" onclick="location.href='memberModify'" value="ICIA 회원관리" style="width: 190px; height: 42px;">
